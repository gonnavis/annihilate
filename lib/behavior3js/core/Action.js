...
export default class Action extends BaseNode {
   ...
   * @memberof Action
   */
  constructor({name = 'Action', title, properties, setTrueKey} = {}){ // todo: class WaitOneFrame in lib, with setTrueKey prop, don't add to class Action directly.
    super({
      category: ACTION,
      name,
      title,
