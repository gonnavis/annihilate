...
// Body.COLLIDING_EVENT_NAME = 'colliding';
...
class World extends EventTarget {
  ...
  internalStep(dt) {
    ...
    for (let k = 0; k !== ncontacts; k++) {
      ...
      // World_step_collidingEvent.body = bj;
      // World_step_collidingEvent.contact = c;
      // bi.dispatchEvent(World_step_collidingEvent);
      // World_step_collidingEvent.body = bi;
      // bj.dispatchEvent(World_step_collidingEvent);
...
// const World_step_collidingEvent = {
//   type: Body.COLLIDING_EVENT_NAME,
//   body: null,
//   contact: null
// };
